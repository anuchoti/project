...
?>
<!-- <section> --><br>
	<nav class="navbar navbar-expand-sm navbar-default sidebar" style="background-color:blue;" id="mainNav">
      <div class="container">
 ...
 <li class="nav-item">
              <?php if($_SESSION['role'] == 'admin'){ 
                echo '<a href="../login.php" class="nav-link">Registered buyers</a>';
              } ?>
            </li>

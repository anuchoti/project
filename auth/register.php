...
<?php include '../include/header.php';?>
	...
	<!-- Services -->
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:lightgreen;" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../anuiindex.html">Logo/Home</a>
			  ...
			  <div class="col-md-8 mx-auto">
			  	<div class="alert alert-info" role="alert">
					...
					?>
				  	...
				  	<form action="" method="post" style="background-color:#f4c2c2;">
				  		<div class="row" >
					  	    <div class="col-6">
					  ...
					  <button type="submit" class="btn btn-primary" name='register' value="register"  style="background-color:green;">Submit</button>
					</form>				
				</div>
			</div>
		</div>

...
<div id="container">
	<div class="shell">
		...
		<div class="small-nav">
			...
			<span>&gt;</span>
			Buyer Requests
			<center><h1><font color="green"><a href="studes.php"><u><b>View Buyer Details.</b></u></a></font></h1></center>
		</div>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Buyer Requests</h2>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th><font color="purple">Buyer Id</font></th>		
...
<div id="footer">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y");?> Home Management System</span>
		<span class="right">
			Designed by ANUSHA</a>
		</span>
	</div>
</div>
<!-- End Footer -->
